...
export function CardDetail({
  ...
  const classNames = ['card-detail', isModal && 'card-detail--modal', className]
    .filter(Boolean)
    .join(' ');
    ...
    <div className={classNames}>
      ...
      <div className="card-detail__info">
        ...
        <div className="card-detail__header">
          ...
          {card.hp && <span className="card-detail__hp">HP {card.hp}</span>}
        </div>
        ...
        {card.legalities && (
          <div className="card-detail__legality">
            ...
            {card.legalities.unlimited && (
              <Badge
                variant={
                  card.legalities.unlimited === 'Legal' ? 'success' : 'error'
                }
              >
                Unlimited
              </Badge>
            ...
            {card.legalities.expanded && (
              <Badge
                variant={
                  card.legalities.expanded === 'Legal' ? 'success' : 'error'
                }
              >
                Expanded
              </Badge>
...
function AttackDisplay({ attack }: AttackDisplayProps) {
  return (
    <div className="card-detail__attack">
      ...
      {attack.text && <p className="card-detail__attack-text">{attack.text}</p>}
    </div>
  );
}
